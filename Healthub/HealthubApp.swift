...
struct HealthubApp: App {
    ...
    @StateObject var pathologiesViewModel = PathologyViewModel(pathologyRepository: PathologyRepository(client: API.Client(dbHelper: CoreDataHelper()), dbHelper: CoreDataHelper()), connectivityProvider: ConnectionProvider(dbHelper:  CoreDataHelper()))
    @StateObject var settingsViewModel = ProfileViewModel(userRepository: UserRepository(client: API.Client(dbHelper: CoreDataHelper()), dbHelper: CoreDataHelper()), connectivityProvider: ConnectionProvider(dbHelper:  CoreDataHelper()))
